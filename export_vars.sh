...
LOCAL_PATH=$PWD/$BASE_DIR
LOCAL_BORZOI_PATH="$LOCAL_PATH/borzoi"
LOCAL_BASKERVILLE_PATH="$LOCAL_PATH/baskerville"
LOCAL_WESTMINSTER_PATH="$LOCAL_PATH/westminster"

CONDA_BASE="$(conda info --base)"
LOCAL_CONDA_PATH="$CONDA_BASE/etc/profile.d/conda.sh"
